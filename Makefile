...
test:
	@echo "$(GMAP_DIR)$(PSEP)$(GMAPI_DIR_NAME)$(PSEP)Product1$(PSEP)$(FAMILY_NAME).gmap$(PSEP)7*$(PSEP)*"
	ls -l "$(GMAP_DIR)$(PSEP)$(GMAPI_DIR_NAME)$(PSEP)Product1$(PSEP)$(FAMILY_NAME).gmap$(PSEP)7*$(PSEP)*"	
